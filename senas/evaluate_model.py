...
def evaluate_model(model, threshold=0.7):
    ...
    with Holistic() as holistic_model:
        ...
        while video.isOpened():
            ...
            # Barra de texto
            cv2.rectangle(image, (0,0), (640, 50), (255, 255, 255), -1)  # Fondo blanco
            cv2.putText(image, ' | '.join(sentence), FONT_POS, FONT, FONT_SIZE, (0, 0, 0), thickness=2)  # Texto negro con sombra
